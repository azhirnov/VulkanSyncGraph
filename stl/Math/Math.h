...
*/
	...
	ND_ forceinline constexpr _vsa_hidden_::EnableForInt<T1, T2, bool>  AdditionIsSafe (const T1 a, const T2 b)
	{
...
*/
	template <typename T1, typename T2>
	ND_ forceinline constexpr _vsa_hidden_::EnableForUInt<T1, T2, bool>  AdditionIsSafe (const T1 a, const T2 b)
	{
		STATIC_ASSERT( IsScalar<T1> and IsScalar<T2> );
